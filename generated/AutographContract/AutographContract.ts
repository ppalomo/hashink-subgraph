...
export class AutographMinted extends ethereum.Event {
  get params(): AutographMinted__Params {
    return new AutographMinted__Params(this);
  }
}

export class AutographMinted__Params {
  _event: AutographMinted;

  constructor(event: AutographMinted) {
    this._event = event;
  }
